-- rc.lua - Awesome configuration file
-- Created by Rudy Seidinger
-- Compatible with awesome v3.4.10 (Exploder)
...
beautiful.init("/home/rudyseidinger/.config/awesome/themes/default/theme.lua")
...
hibernatecmd = "sudo pm-hibernate"
